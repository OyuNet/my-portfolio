...
export default function Hakkimda() {
    ...
    const aboutMe_2 = "Küçük yaşlardan beridir yazılıma ve bilgisayarların işleyişine çok ilgiliyim. 2005 doğumluyum, aslen Sakaryalıyım. 2023 senesinde Eyüp Aygar Fen Lisesinden mezun oldum. 2022 senesinde lisede öğrenim görmekte iken geliştirdiğim yazılım neticesinde Teknofest 2022'den yarışma birincisi olarak ayrıldım.";
    ...
    return (
        <main className="min-h-screen bg-gray-100">
            ...
            <div className="flex flex-col items-center justify-center p-8">
                ...
                <div className="text-center mx-auto max-w-screen-md font-medium">
                    <p className="mb-4 font-medium">{aboutMe_1}</p>
                    <p className="mb-4 font-medium">{aboutMe_2}</p>
                    <p>{aboutMe_3}</p>
                </div>
            </div>
